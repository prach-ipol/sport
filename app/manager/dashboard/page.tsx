...
export default function ManagerDashboard() {
  ...
  const generateStudentsPdf = () => {
    ...
    if (manager) {
      doc.setTextColor(255, 0, 0);
      doc.text('Mentor: ', margin, infoStartY);
      doc.setTextColor(30, 30, 30);
      doc.text(manager.name, margin + 18, infoStartY);
      
      doc.setTextColor(255, 0, 0);
      doc.text('Sport: ', margin, infoStartY + 6);
      doc.setTextColor(30, 30, 30);
      doc.text(manager.sport, margin + 18, infoStartY + 6);
      
      doc.setTextColor(255, 0, 0);
      doc.text('Date: ', margin, infoStartY + 12);
      doc.setTextColor(30, 30, 30);
      doc.text(currentDate, margin + 18, infoStartY + 12);
    } else {
      doc.setTextColor(255, 0, 0);
      doc.text('Date: ', margin, infoStartY);
      doc.setTextColor(30, 30, 30);
      doc.text(currentDate, margin + 18, infoStartY);
    }
    ...
    const tableStartY = (typeof infoStartY !== 'undefined' ? infoStartY + 25 : 48);
